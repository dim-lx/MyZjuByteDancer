...
public class MainActivity extends AppCompatActivity {
    ...
    private void getData(String studentId) {
        new Thread(new Runnable() {
            @Override
            public void run() {
                List<com.bytedance.practice5.model.Message> msgs =
                        baseGetMsgsFromRemote(studentId, "WkpVLWJ5dGVkYW5jZS1hbmRyb2lk");
    ...
    public List<com.bytedance.practice5.model.Message> baseGetMsgsFromRemote(String studentId, String token) {
        String query = "";
        if (studentId != null && !studentId.isEmpty()) {
            query = "?student_id=" + studentId;
        }
        String urlStr =
                String.format("https://api-android-camp.bytedance.com/zju/invoke/messages%s", query);
